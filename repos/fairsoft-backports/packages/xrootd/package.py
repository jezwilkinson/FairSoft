...
class Xrootd(CMakePackage):
    ...
    url = "http://xrootd.slac.stanford.edu/download/v5.5.1/xrootd-5.5.1.tar.gz"
    list_url = "http://xrootd.slac.stanford.edu/dload.html"
#    git = "https://github.com/xrootd/xrootd.git"
    ...
    depends_on('libuuid', when='platform=linux')
    depends_on('util-linux', when='platform=linux')
    depends_on('openssl')
    ...
    def setup_build_environment(self, env):
        ...
        elif self.spec.variants['cxxstd'].value == '20':
            cxxstdflag = self.compiler.cxx20_flag
        else:
